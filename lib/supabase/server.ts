 ...
 * This is used for API routes that need authentication (like /api/settings)
 */
...
/**
 * Creates a Supabase client with service role key for operations that need to bypass RLS
 * This is used for cache operations and other admin tasks
 */
